$PBExportHeader$w_dce001w05_actionfooter.srw
forward
global type w_dce001w05_actionfooter from window
end type
type cb_retrieve from commandbutton within w_dce001w05_actionfooter
end type
type cb_insert from commandbutton within w_dce001w05_actionfooter
end type
type cb_delete from commandbutton within w_dce001w05_actionfooter
end type
type dw_1 from datawindow within w_dce001w05_actionfooter
end type
type cb_clear from commandbutton within w_dce001w05_actionfooter
end type
type cb_save from commandbutton within w_dce001w05_actionfooter
end type
type cb_close from commandbutton within w_dce001w05_actionfooter
end type
type mle_output from multilineedit within w_dce001w05_actionfooter
end type
type mle_view from multilineedit within w_dce001w05_actionfooter
end type
type lb_items from listbox within w_dce001w05_actionfooter
end type
type gb_3 from groupbox within w_dce001w05_actionfooter
end type
type gb_4 from groupbox within w_dce001w05_actionfooter
end type
type gb_5 from groupbox within w_dce001w05_actionfooter
end type
type mle_describe from multilineedit within w_dce001w05_actionfooter
end type
type gb_1 from groupbox within w_dce001w05_actionfooter
end type
type gb_2 from groupbox within w_dce001w05_actionfooter
end type
end forward
...
string title = "DataWiDataWindow ButtonClicked Event In Footer Band"
...
global w_dce001w05_actionfooter w_dce001w05_actionfooter
...
mle_describe.text += "2.Testing Purpose : DataWindow ButtonClicked Event In Footer Band " // This must include
...
lb_items.additem("DCE001W05P001: Button Action As 0-User Defined In Footer Band")
lb_items.additem("DCE001W05P002: Button Action As 1-Retrieve(Yield) In Footer Band")
lb_items.additem("DCE001W05P003: Button Action As 2-Retrieve In Footer Band")
lb_items.additem("DCE001W05P004: Button Action As 4-Page Next In Footer Band")
lb_items.additem("DCE001W05P005: Button Action As 5-Page Prior In Footer Band")
lb_items.additem("DCE001W05P006: Button Action As 6-Page First In Footer Band")
lb_items.additem("DCE001W05P007: Button Action As 7-Page Last In Footer Band")
lb_items.additem("DCE001W05P008: Button Action As 8-Sort In Footer Band")
lb_items.additem("DCE001W05P009: Button Action As 9-Filter In Footer Band")
lb_items.additem("DCE001W05P010: Button Action As 10-Delete Row In Footer Band")
lb_items.additem("DCE001W05P011: Button Action As 11-Append Row In Footer Band")
lb_items.additem("DCE001W05P012: Button Action As 12-Insert Row In Footer Band")
lb_items.additem("DCE001W05P013: Button Action As 13-Update In Footer Band")
lb_items.additem("DCE001W05P014: Button Action As 14-Save Rows As In Footer Band")
lb_items.additem("DCE001W05P015: Button Action As 15-Print In Footer Band")
...
on w_dce001w05_actionfooter.create
...
on w_dce001w05_actionfooter.destroy
...
integer taborder = 20
string title = "none"
string dataobject = "d_dce001w05_button"
