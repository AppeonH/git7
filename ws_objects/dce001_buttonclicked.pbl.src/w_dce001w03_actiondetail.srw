$PBExportHeader$w_dce001w03_actiondetail.srw
forward
global type w_dce001w03_actiondetail from window
end type
type cb_retrieve from commandbutton within w_dce001w03_actiondetail
end type
type cb_insert from commandbutton within w_dce001w03_actiondetail
end type
type cb_delete from commandbutton within w_dce001w03_actiondetail
end type
type dw_1 from datawindow within w_dce001w03_actiondetail
end type
type cb_clear from commandbutton within w_dce001w03_actiondetail
end type
type cb_save from commandbutton within w_dce001w03_actiondetail
end type
type cb_close from commandbutton within w_dce001w03_actiondetail
end type
type mle_output from multilineedit within w_dce001w03_actiondetail
end type
type mle_view from multilineedit within w_dce001w03_actiondetail
end type
type lb_items from listbox within w_dce001w03_actiondetail
end type
type gb_3 from groupbox within w_dce001w03_actiondetail
end type
type gb_4 from groupbox within w_dce001w03_actiondetail
end type
type gb_5 from groupbox within w_dce001w03_actiondetail
end type
type mle_describe from multilineedit within w_dce001w03_actiondetail
end type
type gb_1 from groupbox within w_dce001w03_actiondetail
end type
type gb_2 from groupbox within w_dce001w03_actiondetail
end type
end forward
...
string title = "DataWiDataWindow ButtonClicked Event In Header Detail "
...
global w_dce001w03_actiondetail w_dce001w03_actiondetail
...
mle_describe.text += "2.Testing Purpose : DataWindow ButtonClicked Event In Detail Band " // This must include
...
lb_items.additem("DCE001W03P001: Button Action As 0-User Defined In Detail  Band")
lb_items.additem("DCE001W03P002: Button Action As 1-Retrieve(Yield) In Detail  Band")
lb_items.additem("DCE001W03P003: Button Action As 2-Retrieve In Detail  Band")
lb_items.additem("DCE001W03P004: Button Action As 4-Page Next In Detail  Band")
lb_items.additem("DCE001W03P005: Button Action As 5-Page Prior In Detail  Band")
lb_items.additem("DCE001W03P006: Button Action As 6-Page First In Detail  Band")
lb_items.additem("DCE001W03P007: Button Action As 7-Page Last In Detail  Band")
lb_items.additem("DCE001W03P008: Button Action As 8-Sort In Detail  Band")
lb_items.additem("DCE001W03P009: Button Action As 9-Filter In Detail  Band")
lb_items.additem("DCE001W03P010: Button Action As 10-Delete Row In Detail  Band")
lb_items.additem("DCE001W03P011: Button Action As 11-Append Row In Detail  Band")
lb_items.additem("DCE001W03P012: Button Action As 12-Insert Row In Detail  Band")
lb_items.additem("DCE001W03P013: Button Action As 13-Update In Detail  Band")
lb_items.additem("DCE001W03P014: Button Action As 14-Save Rows As In Detail  Band")
lb_items.additem("DCE001W03P015: Button Action As 15-Print In Detail  Band")
...
on w_dce001w03_actiondetail.create
...
on w_dce001w03_actiondetail.destroy
...
integer taborder = 20
string title = "none"
string dataobject = "d_dce001w03_button"
