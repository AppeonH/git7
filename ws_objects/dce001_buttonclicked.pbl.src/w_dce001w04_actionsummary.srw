$PBExportHeader$w_dce001w04_actionsummary.srw
forward
global type w_dce001w04_actionsummary from window
end type
type cb_retrieve from commandbutton within w_dce001w04_actionsummary
end type
type cb_insert from commandbutton within w_dce001w04_actionsummary
end type
type cb_delete from commandbutton within w_dce001w04_actionsummary
end type
type dw_1 from datawindow within w_dce001w04_actionsummary
end type
type cb_clear from commandbutton within w_dce001w04_actionsummary
end type
type cb_save from commandbutton within w_dce001w04_actionsummary
end type
type cb_close from commandbutton within w_dce001w04_actionsummary
end type
type mle_output from multilineedit within w_dce001w04_actionsummary
end type
type mle_view from multilineedit within w_dce001w04_actionsummary
end type
type lb_items from listbox within w_dce001w04_actionsummary
end type
type gb_3 from groupbox within w_dce001w04_actionsummary
end type
type gb_4 from groupbox within w_dce001w04_actionsummary
end type
type gb_5 from groupbox within w_dce001w04_actionsummary
end type
type mle_describe from multilineedit within w_dce001w04_actionsummary
end type
type gb_1 from groupbox within w_dce001w04_actionsummary
end type
type gb_2 from groupbox within w_dce001w04_actionsummary
end type
end forward
...
string title = "DataWiDataWindow ButtonClicked Event In Summary Band"
...
global w_dce001w04_actionsummary w_dce001w04_actionsummary
...
mle_describe.text += "2.Testing Purpose : DataWindow ButtonClicked Event In Summary Band " // This must include
...
lb_items.additem("DCE001W04P001: Button Action As 0-User Defined In Summary Band")
lb_items.additem("DCE001W04P002: Button Action As 1-Retrieve(Yield) In Summary Band")
lb_items.additem("DCE001W04P003: Button Action As 2-Retrieve In Summary Band")
lb_items.additem("DCE001W04P004: Button Action As 4-Page Next In Summary Band")
lb_items.additem("DCE001W04P005: Button Action As 5-Page Prior In Summary Band")
lb_items.additem("DCE001W04P006: Button Action As 6-Page First In Summary Band")
lb_items.additem("DCE001W04P007: Button Action As 7-Page Last In Summary Band")
lb_items.additem("DCE001W04P008: Button Action As 8-Sort In Summary Band")
lb_items.additem("DCE001W04P009: Button Action As 9-Filter In Summary Band")
lb_items.additem("DCE001W04P010: Button Action As 10-Delete Row In Summary Band")
lb_items.additem("DCE001W04P011: Button Action As 11-Append Row In Summary Band")
lb_items.additem("DCE001W04P012: Button Action As 12-Insert Row In Summary Band")
lb_items.additem("DCE001W04P013: Button Action As 13-Update In Summary Band")
lb_items.additem("DCE001W04P014: Button Action As 14-Save Rows As In Summary Band")
lb_items.additem("DCE001W04P015: Button Action As 15-Print In Summary Band")
...
on w_dce001w04_actionsummary.create
...
on w_dce001w04_actionsummary.destroy
...
integer taborder = 20
string title = "none"
string dataobject = "d_dce001w04_button"
